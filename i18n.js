document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- INICIO: BASE DE DATOS DE TRADUCCIONES (CORREGIDA SIN ASTERISCOS Y SINTAXIS REVISADA) ---
    const translations = {
        "es": {
            ...
            "p1_p_3": "La IA no es la amenaza; es la herramienta que nos libera del trabajo mecánico para que podamos volver a ser lo único que ella no puede ser: <strong>estrategas retóricos</strong>. Para ganar en la era de la IA, no basta con pedirle \"redacta una demanda\". Hay que darle una <strong>cadena de pensamiento</strong> (un Organon) que le ordene cómo pensar como un orador clásico. La IA es el motor. La Retórica Clásica es el timón. Es hora de volver a unir lo que nunca debió separarse.",
            "p2_title": "Mis Servicios: El \"Organon\" Aplicado",
            "p2_s1_title": "1. Diagnóstico Estratégico (Gratuito)",
            "p2_s1_p": "Le ofrezco una demostración de poder. Rellene el formulario y ejecutaré su caso (anónimamente) a través de mi sistema, el <strong>\"Organon de la Persuarsión Judicial\"</strong>. Recibirá un informe preliminar revelando el Status Causae (nudo de la disputa), el Genus Causae (la \"atmósfera\" del caso) y la estrategia de apertura (Proemium) recomendada.",
            "p2_s2_title": "2. Redacción Retórica \"Llave en Mano\"",
            "p2_s2_p": "El servicio completo. Ejecuto el \"Organon\" (Fases I-VII) para su caso y le entrego dos artefactos: un <strong>Escrito Jurídico completo</strong>, optimizado para la persuasión, y el <strong>Informe de Actio</strong>, un manual confidencial para que usted sepa exactamente cómo defenderlo en la vista oral, enfatizando el Pathos y anticipando refutaciones.",
            "p2_s3_title": "3. Consultoría y \"Organones\" a Medida",
            "p2_s3_p": "Para despachos que buscan escalar su calidad persuasiva. Analizo su práctica (penal, mercantil, etc.) y <strong>co-diseño cadenas de pensamiento personalizadas</strong> para sus casos concretos, formando a sus abogados en cómo dirigir la IA para obtener resultados ganadores y consistentes.",
            "p2_cta": "Acceder al Diagnóstico Gratuito",
            "p3_title": "Sobre el Fundador: El Ingeniero Retórico",
            "p3_p_1": "Mi perfil no es el de un 'prompt engineer' tradicional, sino el de un <strong>Ingeniero Retórico</strong>. Mi metodología nace de la intersección única de la Filología Clásica (Retórica, Lógica), la Lingüística Compleja (Latín, Griego y Chino Clásico) y la Ingeniería de Prompts avanzada.",
        ...
        "en": {
            ...
            "p1_p_2": "With the rise of positivism, Law became obsessed with the norm. Logos devoured Pathos and Ethos. Today, Generative AI culminates this process: it is a Logos 'beast', capable of citing more laws and drafting faster than any human. The lawyer who only competes on 'knowing the law' will be replaced. But can AI persuade? No. AI has no strategy, no Phronesis (prudence), no Ethos (credibility). It is a technical genius without a soul.",
            "p1_h3_3": "The Opportunity: Rhetoric as the Rudder",
            "p1_p_3": "AI is not the threat; it is the tool that frees us from mechanical work so we can go back to being the one thing it cannot be: <strong>rhetorical strategists</strong>. To win in the age of AI, it's not enough to ask it to 'draft a complaint'. You must give it a <strong>chain of thought</strong> (an Organon) that commands it how to think like a classical orator. AI is the engine. Classical Rhetoric is the rudder. It is time to reunite what should never have been separated.",
            "p2_title": "My Services: The \"Organon\" Applied",
            "p2_s1_title": "1. Strategic Diagnosis (Free)",
            "p2_s1_p": "I offer you a demonstration of power. Fill out the form, and I will (anonymously) run your case data through my system, the <strong>\"Organon of Judicial Persuasion\"</strong>. You will receive a preliminary strategic report revealing your case's Status Causae (the true heart of the dispute), the Genus Causae (the case's 'atmosphere' and how to approach it), and the recommended opening strategy (Proemium).",
            "p2_s2_title": "2. \"Turnkey\" Rhetorical Drafting",
            "p2_s2_p": "The full service. I execute the complete \"Organon\" (Phases I-VII) for your case and deliver two artifacts: a <strong>complete Legal Pleading</strong>, optimized for persuasion, and the <strong>'Actio Report'</strong>, a confidential instruction manual for you, the lawyer, on how to defend that brief in court, what Pathos points to emphasize, and what refutations to anticipate.",
            "p2_s3_title": "3. Custom \"Organon\" Design & Consulting",
            "p2_s3_p": "For firms seeking to scale their persuasive quality. I analyze your specific practice (criminal, commercial, etc.) and <strong>co-design custom chains of thought</strong> for your specific cases, training your attorneys on how to direct AI to achieve winning, consistent results.",
            "p2_cta": "Access Free Diagnosis",
            "p3_title": "About the Founder: The Rhetorical Engineer",
            "p3_p_1": "My profile is not that of a traditional 'prompt engineer', but that of a <strong>Rhetorical Engineer</strong>. My methodology is born from the unique intersection of Classical Philology (Rhetoric, Logic), Complex Linguistics (Latin, Greek, and Classical Chinese), and advanced Prompt Engineering.",
        ...
        "zh-tw": {
            ...
            "p1_h3_1": "起源：當律師即是演說家",
            "p1_p_1": "對西塞羅和昆體良來說，法律（Ius）與演說藝術（Ars Dicendi）密不可分。律師不僅是規則的管理者，更是說服的策略家。目標不僅是持理有據（法律的 Logos），更是要讓法官感受到正義（Pathos）並信任演說者的信譽（Ethos）。曾經，贏得一個案件不只靠引用法律，更靠在法庭上建構真相。",
            ...
            "p1_h3_3": "機遇：以修辭為舵",
            "p1_p_3": "AI不是威脅；它是一個將我們從機械性工作中解放出來的工具，讓我們能回歸到它唯一不能成為的角色：<strong>修辭策略家</strong>。在AI時代要贏，光是叫它『起草訴狀』是不夠的。你必須給它一個<strong>思維鏈</strong>（一個 Organon），命令它如何像古典演說家一樣思考。AI是引擎，古典修辭是舵。是時候將本不該分離的事物重新結合起來了。",
            "p2_title": "我的服務：「Organon」的應用",
            "p2_s1_title": "1. 策略診斷（免費）",
            "p2_s1_p": "我為您提供一次實力展示。填寫表單，我將（匿名）透過我的系統<strong>「司法說服之Organon」</strong>來運行您的案件數據。您將收到一份初步的策略報告，揭示您案件的 Status Causae（真正爭議點）、Genus Causae（案件的「氛圍」與應對方式）以及推薦的開場策略（Proemium）。",
            "p2_s2_title": "2. 「一站式」修辭寫作",
            "p2_s2_p": "完整的服務。我為您的案件執行完整的「Organon」（階段 I-VII），並交付兩項成果：一份<strong>完整的法律文書</strong>，經說服力優化，以及一份<strong>《Actio 報告》</strong>，這是一份給您（律師）的機密操作手冊，指導您如何在法庭上為該文書辯護，強調哪些 Pathos，並預測哪些反駁。",
            "p2_s3_title": "3. 事務所諮詢與客製化「Organon」設計",
            "p2_s3_p": "為尋求提升說服品質的事務所服務。我分析您的特定業務（刑事、商業等），並<strong>共同設計客製化的思維鏈</strong>，培訓您的律師如何指導AI以獲得一致的致勝成果。",
            "p2_cta": "獲取免費診斷",
            "p3_title": "關於創始人：修辭工程師",
            "p3_p_1": "我的簡介並非傳統的「提示工程師」，而是一名<strong>修辭工程師</strong>。我的方法論誕生於古典文獻學（修辭學、邏輯學）、複雜語言學（拉丁語、希臘語、古漢語）與先進提示工程的獨特交集。",
            "p3_p_2": "我不教AI寫什麼；我教它如何思考。",
            "p3_h3_1": "關鍵資歷",
    ...
    function applyTranslations(langData) {
        ...
        document.querySelectorAll('[data-i18n-key]').forEach(element => {
            ...
            if (langData[key]) {
                // Usamos 'innerHTML' para permitir etiquetas <strong>
                // Y verificamos si es placeholder
                if (element.hasAttribute('placeholder') || element.tagName === 'INPUT' || element.tagName === 'TEXTAREA') {
                    // Solo actualiza placeholder si la clave existe para él
                    // (Evita borrar placeholders si no hay traducción específica para ellos)
                    if (element.hasAttribute('data-i18n-placeholder') && langData[key]) {
                       element.placeholder = langData[key];
                    } else if (element.tagName !== 'INPUT' && element.tagName !== 'TEXTAREA') {
                       // Si no es input/textarea, usa innerHTML para el contenido principal
                       element.innerHTML = langData[key];
                    }
                } else if (element.tagName === 'TITLE') {
                    element.textContent = langData[key]; // Title no usa innerHTML
                }
                 else {
                    element.innerHTML = langData[key]; // Para todos los demás elementos
                }
            } else {
